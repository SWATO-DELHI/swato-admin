...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  return (
    <div
      className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw] transition-colors relative"
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <button type="submit" className="animate-element animate-delay-600 w-full rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 py-4 font-medium text-white hover:from-orange-600 hover:to-red-600 transition-colors">
                Sign In
              </button>
            </form>
            ...
            <button onClick={onGoogleSignIn} className="animate-element animate-delay-800 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary dark:hover:bg-zinc-800 transition-colors text-foreground">
                <GoogleIcon />
